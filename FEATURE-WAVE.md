...
Astral Guide chat, daily briefing, saved memories, mood check-in, idea generator, focus checklist, prompt packs, chat export, keyboard commands, local privacy mode, quick links, activity digest, post starters, ride tips, Studio shortcuts, theme suggestions, weekly goals, crew icebreakers, decision helper, and notification quiet hours.

Astral Guide is a local assistant: chat, memory, mood, tasks, command replies, export, quick launch, and privacy copy all work in the browser without an API key or automatic posting.
